...
public class UserActionsController {
    ...
    public String createPlaylist(@RequestBody UsernamePlaylistNameReq req){
        return userActionsServices.createPlaylist(req);
    }

    @PostMapping("/deletePlaylist")
    public String deletePlaylist(@RequestBody UsernameIdReq req){
        return userActionsServices.deletePlaylist(req);
    }

    @PostMapping("/addSongToPlaylist")
    public String addSongToPlaylist(@RequestBody AddSongToPlaylistReq req){
        return userActionsServices.addSongToPlaylist(req);
    }

    @PostMapping("/deleteSongFromPlaylist")
    public String deleteSongFromPlaylist(@RequestBody DeleteSongFromPlaylist req){
        return userActionsServices.deleteSongFromPlaylist(req);
    }
